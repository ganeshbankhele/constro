...
export class TabScrollComponent implements AfterViewInit {
  ...
  ngAfterViewInit() {
    ...
    this.renderer.setElementStyle(this.nativeTabbar, "overflow-x", "none");
    ...
    if (typeof this.nativeTabbar != 'undefined') {
      ...
      for (let i = 0; i < numOfTabs; i++) {
        ...
        if (this.tabs[i]._isShown) {
          ...
          // this.renderer.setElementStyle(element, 'background-color','#790e8b' );
          // this.renderer.setElementStyle(element, 'color','#EF99FE' );
          ...
          if (element.classList.contains("has-title-only")) {
            ...
            this.renderer.setElementStyle(element, 'padding-top', '2rem');
  ...
  scrollToselectedTab() {
    if (typeof this.nativeTabbar != 'undefined') {
      ...
      //this.renderer.setElementStyle(selectedTab, 'border-bottom','1px solid #fff' );
